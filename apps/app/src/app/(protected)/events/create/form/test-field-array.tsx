...
export const TestFieldArray = (props: Props) => {
  ...
  type IvalidationSchema = Yup.InferType<typeof validationSchema>;
  ...
  console.log('🚀  file: test-field-array.tsx:25  control:', control);
  console.log('🚀  file: test-field-array.tsx:27  fields:', fields);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className='card m-3'>
        ...
        {fields.map((item, i) => {
          console.log('🚀  file: test-field-array.tsx:79  item:', item);
